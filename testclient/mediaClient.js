import * as mediasoupClient from 'https://esm.sh/mediasoup-client@3'; // Browser-side mediasoup client library

export class MediaClient {
  constructor(serverUrl) {
    this.socket = io(serverUrl);                  // Open a Socket.io connection to the signaling server
